...
class Ventas extends CI_Controller {
    ...
    public function listarVentasPorDocumentoCliente() {
        $numeroDocumento = $this->input->post('numero');
        $cantidad = $this->input->post('cantidad');
        $ventas = $this->venta_model->listarVentasPorDocumentoCliente($numeroDocumento, $cantidad);
        echo json_encode($ventas);
    }
	...
	public function listarJson(){	
        ...
        if ($vendedorId == 1) {
            $ventas = $this->venta_model->listarVentas2($fechaDesde->format('Ymd'), $fechaHasta->format('Ymd'), $tiendaId, $estadoId, $vendedorId);
        } else {
            $ventas = $this->venta_model->listarVentas2($fechaDesde->format('Ymd'), $fechaHasta->format('Ymd'), $tiendaId, $estadoId, $vendedorId);
        }
        $data = [];
    ...
    public function registrar(){    
        ...
        $tiendas = $this->tienda_model->getList();
        $metodos = $this->venta_model->getMetodosPago('ING');
        $usuario = $this->session->userdata('user');
        $js = [
            'sale-model.js?v=1.0', 
            'sales/sale-add-v2.js?v=1.3'
        ];
        $css = [];
        $datos = [
        ...
        try {
            ...
            */
            ...
            $venta = [
                ...
                'totalDescuento'=>$ventaTemp->totalDescuento,
    ...
    public function editar() {
        ...
        $historial2 = $this->venta_model->listarVentasPorDocumentoCliente($venta->customer->nro_documento,10);
