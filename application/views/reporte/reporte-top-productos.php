...
<div class="content-wrapper">
    ...
    <!-- Content area -->
    <div class="content">
        <h4 style="font-weight: bold; text-decoration: underline">REPORTE TOP PRODUCTOS</h4>
        <div class="card">
                                ...
                                <div class="row">
                                    <div class="col-sm-6 col-md-4">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-8">
                                                <select name="cantidadMostrar" id="cantidadMostrar"
                                                    class="form-control">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-8">
                                                <select name="categoria" id="categoria" class="form-control">
                                                    ...
                                                    <option value="<?php echo $value->categoriaId?>"><?=$value->nombre?>
                                                    </option>
                                                    <?php endforeach; ?>
                                                </select>
                                            </div>
            ...
            <div class="card-body">
                <div class="table-responsive">
                    <table class="table table-bordered" data-select="true" data-navigator="true" id="rptTopProductos">
                        <thead>
                            <tr>
                                <th style="width: 50px">#</th>
                                <th style="width: 100px">Codigo</th>
                                <th style="width: 250px">Descripción</th>
                                <th style="width: 200px">Color/Talla/Diseño</th>
