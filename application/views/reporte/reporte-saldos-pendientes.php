...
<div class="content-wrapper">
    ...
    <!-- Content area -->
    <div class="content">
        <h4 style="font-weight: bold; text-decoration: underline">REPORTE VENTAS CON SALDOS PENDIENTES</h4>
        <div class="card">
...
<ul id="contextMenuReporte" class="list-group" role="menu" style="display:none">
    ...
    <!-- <li class="list-group-item pt-1 pb-1"><a class="text-blue-800 font-weight-bold" tabindex="-1" id="mnDevolver"
