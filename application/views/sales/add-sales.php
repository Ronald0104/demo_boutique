                    ...
                    <div id="collapsible-styled-group1" class="collapse show" style="">
                        <div class="card-body">
                            <ul class="nav nav-tabs nav-tabs-top">
                                ...
                                <li class="nav-item d-none"><a href="#top-tab-historial" class="nav-link font-weight-bold" data-toggle="tab">Historial</a></li>
                            </ul>
                        ...
                        <table class="table table-bordered" data-select="true" data-navigator="true">
                            <thead>
                                <tr>
                                    ...
                                    <th>Categoria</th>
                                    <!-- <th>Cantidad</th> -->
                                    <th style="min-width:65px">Precio</th>
                                    <!-- <th>Importe</th> -->
                                        ...
                                        <div class="card mb-0 mr-3" style="width: 100%">
                                            ...
                                            <div class="card-body inline">
                                                <div class="row mb-1">
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-lg-8">
                                                                <select name="tipoTarjeta" id="tipoTarjeta" class="form-control">
                                                                    ...
                                                                    <option value="<?php echo $metodo->tipoPagoId;?>"><?php echo $metodo->descripcion ?></option>
                                                                    <?php endforeach; ?>
                                                                </select>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="col-sm-4">
                                                        <div class="form-group row">
                                                            <label class="col-lg-4 col-form-label form-control-label">N° Operación:</label>
                                                            <div class="col-lg-8">
            ...
            <div class="card mb-2">
                ...
                <div id="collapsible-styled-group4" class="collapse show">
                    <div class="card-body" id="card-history-client">                        
                        <div class="table-responsive">
                            <table class="table table-bordered d-none" data-select="true" data-navigator="true" id="table-history-client">
                                <thead>
                                    <tr>
                                        <th>#</th>
                                        <th>N° Ticket</th>
