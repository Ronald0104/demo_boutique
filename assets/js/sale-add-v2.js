...
$(function () {
	...
	$('#fechaSalida').datepicker({ dateFormat: 'dd/mm/yy', minDate: '-1M', maxDate: '+12M', showOtherMonths: true });
	$('#fechaDevolucion').datepicker({ dateFormat: 'dd/mm/yy', minDate: '-1M', maxDate: '+12m', showOtherMonths: true });
	$('#fechaRegistro').datepicker({ 
		dateFormat: 'dd/mm/yy', minDate: '-1M', maxDate: '+1D',
	...
	$('#tipoOperacion').change(function() {
		...
		if ($tipo == 1){
			...
			$('#estado').append($('<option>').prop('value', 5).text("SERVICIO"));
		}
