...
var fn_ListarVentas = function () {
    table = $('#tbl_sales').DataTable({
        ...
        footerCallback: function (row, data, start, end, display) {
            ...
            // Descuento
            descuento = api.column(6).data().reduce(function (a, b) { return intVal(a) + intVal(b); }, 0);
            // A Cuenta Anterior
            ...
            efectivo = api.column(8).data().reduce(function (a, b) { return intVal(a) + intVal(b); }, 0);
            tarjeta = api.column(9).data().reduce(function (a, b) { return intVal(a) + intVal(b); }, 0);
            // Saldo
            saldo = api.column(10).data().reduce(function (a, b) { return intVal(a) + intVal(b); }, 0);
            // Garantia
            garantia = api.column(11).data().reduce(function (a, b) { return intVal(a) + intVal(b); }, 0);

            // Update footer
            $(api.column(5).footer()).html('<h5><b>S/' + Number(total).toFixed(2) + '</b></h5>');
            $(api.column(6).footer()).html('<h5><b>S/' + Number(descuento).toFixed(2) + '</b></h5>');
            $(api.column(7).footer()).html('<h5><b>S/' + Number(cuentaAnterior).toFixed(2) + '</b></h5>');
            $(api.column(8).footer()).html('<h5><b>S/' + Number(efectivo).toFixed(2) + '</b></h5>');
            $(api.column(9).footer()).html('<h5><b>S/' + Number(tarjeta).toFixed(2) + '</b></h5>');
            $(api.column(10).footer()).html('<h5><b>S/' + Number(saldo).toFixed(2) + '</b></h5>');
            $(api.column(11).footer()).html('<h5><b>S/' + Number(garantia).toFixed(2) + '</b></h5>');
        },
